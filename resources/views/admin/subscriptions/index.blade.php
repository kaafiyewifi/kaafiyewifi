    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-4">
        ...
        @if(Route::has('admin.subscriptions.create'))
            <a
                ...
                class="inline-flex items-center justify-center rounded-xl bg-orange-500 px-5 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-orange-600 shrink-0"
            >
                + Create Subscription
            </a>
        @endif
                    ...
                    <div class="flex flex-col items-stretch gap-3 sm:flex-row xl:justify-end">
                        ...
                        @if(request()->filled('q'))
                            <a
                                ...
                                class="inline-flex items-center justify-center rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800 shrink-0"
                            >
                                Reset
                            </a>
                        @endif
